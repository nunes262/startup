...
export const AutomationSection = () => {
    return (
        <section className="flex items-center justify-center flex-col gap-4">
            <Header title={"System Automation"} subtitle={"Our Automation"} />

            <div className="md:w-2/3 flex items-center flex-col md:flex-row justify-between gap-10 mt-8 p-4 rounded-3xl shadow-xl bg-white">
